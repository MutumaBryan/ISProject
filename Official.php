...
<nav class="navbar navbar-light" style="background-color: #64B5F6">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li ><a href="clubOfficial.php">Manage Your Club</a></li>
...
<!-- the bottom navigation bar-->
        <div class="wrapper">
            <footer>
                <div class="clearfix">
                    <ul class="nav navbar-nav">
                        <li><a href="https://www.facebook.com/StrathmoreUniversity/"><img src="PICS/icons8-Facebook-48.png" width="30px" height="30px"/></a></li>
                        <li>
                            <div id='contact'><img height="30px" src="PICS/icons8-WhatsApp-48.png" width="30px"></div>
			</li>
                        <li><a href="https://twitter.com/strathu?lang=en"><img src="PICS/icons8-Twitter-50.png" width="30px" height="30px"/></a></li>
                    </ul>
                </div>
            </footer>
        </div>
