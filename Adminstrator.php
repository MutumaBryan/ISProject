...
label {
	...
	<ul id="accordion" class="accordion">
		...
		<li>
			<div class="link"><i class="glyphicon glyphicon-briefcase"></i>Manage Clubs<i class="fa fa-chevron-down"></i></div>
			<ul class="submenu">
                            <li><a href="addremove.php">Add or Remove Club Official</a></li>
                            <li><a href="addremove_1.php">Add or Remove Club Member</a></li>
                            <li><a href="addremove_2.php">Activate, Deactivate or Remove Club</a></li>
                            <li><a href="createclub.php">Create New club</a></li>
			</ul>
		</li>
		<li>
			<div class="link"><i class="glyphicon glyphicon-list-alt"></i>Club Details<i class="fa fa-chevron-down"></i></div>
			<ul class="submenu">
                            <li><a href="AdminMembers.php">Club Members & Officials</a></li>
                            <li><a href="Adminmeeting.php">Club Meetings</a></li>
			</ul>
		</li>
                <li>
			...
			<ul class="submenu">
                            ...
                            <li><div id='contact'>Add Club Image</div></li>
        ...
        <div class="content">
                    <section>
                        <form action="Adminstrator.php" method="POST" name="evForm" enctype="multipart/form-data">
                        <input type="text" class="form-control" name="clubid" placeholder="Club ID" required="required"><br>
